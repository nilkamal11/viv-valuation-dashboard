...
export const fundingPlans=[
 ...
 {id:'blend',name:'Use $500k cash + sell $1.5m',cashUsed:500_000,sales:1_500_000,external:0,why:`Sells fewer investments while retaining about ${Math.round((positiveCash-500_000)/1000)}k of positive cash balances before costs.`,tradeoff:'Reduces the cash available for assignments and capital calls. The remaining balance is not a verified adequate reserve.'},
...
// Both plans clear the negative cash principal first, then reduce fixed advances.
...
export const ratePlan=repaymentPlan(['holding-028','holding-029','holding-027','holding-024','holding-026','holding-030','holding-025']);
export const currencyPlan=repaymentPlan(['holding-024','holding-030','holding-028','holding-029','holding-027','holding-026','holding-025'],{'holding-024':1_192_464.76,'holding-030':494_023.72});
